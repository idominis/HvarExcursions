...
<div class="uk-section uk-padding-remove-top">
    ...
    <div class="uk-cust-container-full-width">
        <div class="uk-cust-container-full-width__inner" style="padding: 5px;">
            <div class="uk-light">
                <div data-uk-grid class="uk-grid uk-grid-small uk-child-width-1-2 uk-child-width-1-3@s">
                    <div>
                        <div class="uk-inline-clip uk-transition-toggle he-explore-clip">
                    ...
                    <div>
                        <a href="<?= site_url('excursions/tour_vis'); ?>" class="uk-inline-clip uk-transition-toggle he-explore-clip">
    ...
    <div class="uk-container">
        ...
        <div class="he-yt-video">
            <div data-uk-lightbox>
                <a href="https://www.youtube.com/watch?v=Xveg6s-j5c0" class="uk-inline">
                    <img src="<?= base_url('img/experience-preview.jpg'); ?>" alt="Experience Preview" class="he-yt-video__preview">
                </a>
            </div>
        </div>
    </div>
